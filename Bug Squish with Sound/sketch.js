...
let spriteSheetFilenames = ["56425 (1).png", "56428.png"];
let spriteSheets = [];
let animations = [];
let sample;
let sample2;
...
let game = { score: 10, maxScore: 0, maxTime: 10, elapsedTime: 0, totalSprites: 15, state: GameState.Start, targetSprite: 1 };

function preload() {
  
  sample = loadSound('assets/squish_sound.mp3')
  sample2 = loadSound('assets/miss.mp3')
  sample3 = loadSound('assets/game_over.mp3')
  background_music = loadSound('assets/background.mp3')
...
function keyPressed() {
  switch(game.state) {
    ...
    case GameState.GameOver:
      ...
      game.state = GameState.Playing;
      background_music.play('G2', vel = 0.1, time = 0);
      break;
  }
}
